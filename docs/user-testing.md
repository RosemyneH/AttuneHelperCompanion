...
- **Play Game** should start **WoWExt.exe** / **WowExt.exe** with any user-entered **Launch parameters**; on Linux it should work through Wine or Proton.

## Launch parameters (manual)
- **Launch parameters** should stay editable and be passed through as-is to the WoWExt launcher.
- The desktop app should not show AwesomeWotLK account, realm, password, or autologin controls.
